...
from .modules import ART, GlobalMultiViewFusion
from .modules_ablation import IdentityOCVA as OCVA
from .gpu_preprocess import qwen_vl_preprocess_torch, resize_image_mask_torch
from .losses import CombinedLoss


class CrossViewerModelNoCrossAttn(nn.Module):
    """CrossViewer ablation that removes cross-view attention."""
    ...
    def __init__(self,
        ...
        print("=" * 80)
        print("Initializing CrossViewerModel (ablation: w/o CrossView Attn)...")
        print("=" * 80)
...
if __name__ == "__main__":
    ...
    print("Testing CrossViewerModelNoCrossAttn...")

    model = CrossViewerModelNoCrossAttn(
        vision_encoder_path="Qwen/Qwen3-VL-8B-Instruct",
        freeze_vision_encoder=True,
        freeze_llm=True
    )
